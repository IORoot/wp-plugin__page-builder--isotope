...
if( function_exists('acf_add_local_field_group') ):
    ...
    <button class="[BUTTON_CLASSES]" value=".balancing">Balancing</button>',
                    ...
                    'layout_621b487e3ce68' => array(
                        'key' => 'layout_621b487e3ce68',
                        'name' => 'filter_search',
                        'label' => '<span class="mdi mdi-magnify"></span> Search Box',
                        'display' => 'block',
                        'sub_fields' => array(
                            array(
                                'key' => 'field_621b487e3ce69',
                                'label' => '<span class="mdi mdi-magnify"></span> Search Filter',
                                'name' => '',
                                'type' => 'tab',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'field_621b49973ce7a',
                                'label' => 'Search Classes',
                                'name' => 'search_classes',
                                'type' => 'text',
                                'instructions' => 'Classes to add onto the input textbox.',
                                'required' => 0,
                                'conditional_logic' => 0,
                                'wrapper' => array(
                                    'width' => '',
    ...
    <p>Classes that start with a number (like <code>.9</code> or <code>.4horses</code>) are invalid classnames. Therefore the filter will automatically append the name of the filter to the front of it on the grid-item. So it\'ll become <code>.award_level9</code></p>
    <p>Therefore, within the cell, make sure you append the filter name also.</p>
    <p>Before: <code>&lt;div class=&quot;award_level {{award_level}} hidden&quot;&gt;{{award_level}}&lt;/div&gt;</code></p>
    <p>After: <code>&lt;div class=&quot;award_level award_level{{award_level}} hidden&quot;&gt;{{award_level}}&lt;/div&gt;</code></p>',
                'new_lines' => 'wpautop',
                'esc_html' => 0,
            ),
            array(
